  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Request withdraw</div>
           <hr>
            <form method="post">
           <div class="form-group">
            <label for="input-1">amount</label>
            <input type="number" name="amount" class="form-control" id="input-1" placeholder="Enter amount">
           </div>
           <div class="form-group">
            <button type="submit" name="request" class="btn btn-light px-5">Send</button>
          </div>
          </form>
         </div>
         </div>
