...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       <h5 class="logo-text">Smart toilette | Admin</h5>
     </a>
   </div>
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="usertr.php">
        <i class="icon-grid mr-2"></i> <span>User transactions</span>
        </a>
      </li>
      <li>
        <a href="sellerstr.php">
        <i class="icon-grid mr-2"></i> <span>Seller transactions</span>
        </a>
      </li>
      <li>
        <a href="withdraw.php">
